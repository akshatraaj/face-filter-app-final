    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.upperContainer}>
          ...
          <Text style={styles.appName}>Your Look Changer</Text>
        </View>
        <View style={styles.middleContainer}>
          <View style={styles.contentContainer}>
            <View style={styles.textContainer}>
              <Text style={styles.contentText}>
              Your Look Changer is an easy to use photo editor that helps you retouch your selfies and acts as your own personal glam squad when it comes to enhancing your digital look.
              </Text>
            </View>
